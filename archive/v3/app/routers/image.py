...
``absolute`` / ``pairwise`` / ``both`` mode. Mirrors the v2 ``/api/image/*``
...
MODALITIES = {Modality.T2I.value, Modality.I2I.value}
...
def list_jobs(
    ...
    return {"modality": "image", "suite_id": suite_id, "executions": docs}
